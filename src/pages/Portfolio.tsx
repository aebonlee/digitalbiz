...
import { getPortfolios, PortfolioRecord } from '../utils/supabase';
                    ...
                    <div className="lecture-card-body">
                      ...
                      {item.tags && (
                        <div className="lecture-card-tags">
                          {(Array.isArray(item.tags) ? item.tags : (item.tags as unknown as string).split(',')).map((tag: string, i: number) => (
