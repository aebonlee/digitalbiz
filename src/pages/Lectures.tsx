...
import { getLectures, incrementLectureViews, LectureRecord } from '../utils/supabase';
...
const Lectures = () => {
  ...
  const toggleExpand = (lecture: LectureRecord) => {
  ...
  const handleFileAction = (e: React.MouseEvent, _lecture: LectureRecord) => {
    if (!isLoggedIn) {
      e.preventDefault();
